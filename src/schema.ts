...
export const CreateItemRequestHeaders = z.intersection(
  z.object({
    ...
    'x-archive-interactive-priority': z.number().optional(),
    'x-archive-meta-identifier': z.string().or(z.number()),
    'x-archive-meta-collection': z.string().or(z.number()).optional(),
    'x-archive-meta01-collection': z.string().or(z.number()).optional(),
    'x-archive-meta02-collection': z.string().or(z.number()).optional(),
    'x-archive-meta-mediatype': Mediatype,
